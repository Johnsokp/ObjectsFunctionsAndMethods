...
def try_methods_and_functions():
    ...
    #
    ####################################################################
    kynon = rg.SimpleTurtle()
    kynon.pen = rg.Pen('blue', 5)

    kynon.backward(150)
    kynon.speed = 1
    draw_many_squares(kynon, 2, 100, 30)
    kynon.speed = 5
    kynon.pen.color = 'red'
    draw_many_squares(kynon, 10, 50, 15)
    kynon.speed = 100
    kynon.pen.thickness = 35
    draw_many_squares(kynon, 8, 300, 60)
    kynon.pen = rg.Pen('black', 3)
    kynon.backward(200)
    kynon.draw_circle(30)
    kynon.draw_square(50)
