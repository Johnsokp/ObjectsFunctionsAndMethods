...
def turtle4():
    """
    Constructs a default SimpleTurtle.
    Makes that SimpleTurtle go forward 150 units
    and then draw a black-filled circle.
    """
    kynon = rg.SimpleTurtle()
    kynon.pen = rg.Pen('orange', 20)

    kynon.forward(100)

    kynon.begin_fill()
    kynon.draw_circle(150)
    kynon.end_fill()
...
def turtle5():
        ...
        billy.pen = rg.Pen('orange', 20)

        billy.left(100)

        billy.begin_fill()
        billy.draw_circle(150)

        bob = rg.SimpleTurtle()
        bob.pen = rg.Pen('orange', 20)
